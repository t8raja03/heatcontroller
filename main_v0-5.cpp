...
{  
    double vrt = tin * (3.3 / 4096);
    double vr = 3.3 - vrt;
    double rt = vrt / (vr / 10000); //toinen vastus
   
    double ln = log(rt / 10000); //ntc vastus
   
    double temperature = (1 / ((ln / 3839) + (1 / 25))) - 273.15;
...
int main()
{
    ...
    if (NTC == 1) temp = getTemperature();//Tähän lämpötilan haku muuttujaan
